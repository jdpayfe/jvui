<template>
    <div class="jv-picker">
        <div class="jv-picker__toolbar jv-hairline--top-bottom" v-if="showToolbar">
            <slot>
                <div class="jv-picker__cancel" @click="emit('cancel')">{{ cancelButtonText || $t('cancel') }}</div>
                <div class="jv-picker__title jv-ellipsis" v-if="title" v-text="title"/>
                <div class="jv-picker__confirm" @click="emit('confirm')">{{ confirmButtonText || $t('confirm') }}</div>
            </slot>
        </div>
