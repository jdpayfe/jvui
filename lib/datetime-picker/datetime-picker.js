...
export default {
    ...
    methods: {
        ...
        getBoundary: function getBoundary(type, value) {
            ...
            return _ref = {}, _defineProperty(_ref, type + 'Year', year), _defineProperty(_ref, type + 'Month', month), _defineProperty(_ref, type + 'Date', date), _defineProperty(_ref, type + 'Hour', hour), _defineProperty(_ref, type + 'Minute', minute), _ref;
        },
